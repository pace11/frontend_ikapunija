                ...
                <div className="panel-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="form-group">
                        <label>
                          Email <span className="text-danger txt-sm">*</span>
                        </label>
                        <input
                          value={data.email}
                          onChange={(e) =>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>
                          Password <span className="text-danger txt-sm">*</span>
                        </label>
                        <input
                          value={data.password}
                          onChange={(e) =>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-group">
                        <label>
                          Alamat <span className="text-danger txt-sm">*</span>
                        </label>
                        <textarea
                          type="text"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>
                          No Hp <span className="text-danger txt-sm">*</span>
                        </label>
                        <input
                          value={data.contact}
                          onChange={(e) =>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>
                          Angkatan <span className="text-danger txt-sm">*</span>
                        </label>
                        <select
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>
                          Jurusan <span className="text-danger txt-sm">*</span>
                        </label>
                        <select
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>
                          Profesi <span className="text-danger txt-sm">*</span>
                        </label>
                        <select
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-group">
                        <label>
                          NIK <span className="text-danger txt-sm">*</span>
                        </label>
                        <input
                          value={data.nik}
