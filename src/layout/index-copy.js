    ...
    <div class="container-xxl bg-white p-0">
      ...
      <div class="container-xxl position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
          <a href="#a" class="navbar-brand p-0">
            <h1 class="text-primary m-0">
              <i class="fa fa-hand-holding me-3"></i>YBM Brillian
            </h1>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="#a" class="btn btn-primary py-2 px-4">
              CMS Login
            </a>
          </div>
        </nav>
          ...
          <div class="container my-5 py-5">
            <div class="row align-items-center g-5">
              <div class="col-lg-6 text-center text-lg-start">
                <h1 class="display-3 animated slideInLeft">
                  YBM Brillian
                </h1>
              ...
              <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                <img class="img-fluid" src={require("../assets/image/photo-1.jpg").default} alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <div class="d-flex pt-2">
                <a class="btn btn-outline-light btn-social" href="#a">
                  <i class="fab fa-twitter"></i>
                </a>
                <a class="btn btn-outline-light btn-social" href="#a">
                  <i class="fab fa-facebook-f"></i>
      ...
      <a href="#q" class="btn btn-lg btn-primary btn-lg-square back-to-top">
